![Logo, a literal switch register](Emoji/Computing/switch_register.gif)

# Switch Register

This is a collection of <!--EmojiCountReplacementTarget See Scripts/Add new emoji to documentation.linq for details. -->1368 emoji that are free to use with [attribution](#license).
